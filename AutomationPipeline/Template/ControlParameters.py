...
RECORD_TIME = 149       # centiseconds: desired intent window before transition state
SAMPLE_RATE = 100       # desired samples per second (must be value between 1 to 100)
RT_INC = 10             # centiseconds: RECORD_TIME interval step
...
# - CrutchReadingsR         x 06     ind: 07 - 12        # I thnk right?
