    ...
    # - Found stationary State
        ...
        # - Extracting intent into string CSV
            ...
            for sampleFactor in SR_INC:
                ...
                #bp()
                filtCapture = sampleIntent(capture, sampleFactor) #-record & sample as global Variables                
            ...
            # - Automate naming and saving file to directory
                f = open(DIR_INTENT+"Exp_"+str(intent_ID)+"-"+intent+"-"+"SR_"+str(int(SAMPLE_RATE/sampleFactor))+"-"+"RT_"+str(RECORD_TIME)+".csv", "w")
                f.write(csvOutput)
                f.close()
