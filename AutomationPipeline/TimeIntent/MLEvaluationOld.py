...
keys_seeds = list(pickleDict[keys_state[0]].keys())
keys_metrics = list((pickleDict[keys_state[0]])[keys_seeds[0]].keys())

# =============================================================================
# === Find std dev and avg performance across seeds ===========================
# =============================================================================
...
for tr in range(RT_INC, RECORD_TIME+1, RT_INC):
    time_record_len.append(tr)
